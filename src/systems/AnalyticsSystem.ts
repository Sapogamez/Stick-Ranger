...
export type EventType = 
  | 'game_start' | 'game_end' | 'level_start' | 'level_complete' | 'level_fail'
  | 'player_death' | 'enemy_kill' | 'skill_use' | 'item_collect' | 'setting_change'
  | 'performance_warning' | 'error' | 'user_action';
...
export class AnalyticsSystem {
  ...
  private playerBehavior: PlayerBehaviorMetrics;
  ...
  private initializePlayerBehavior(): PlayerBehaviorMetrics {
    return {
      actionsPerMinute: 0,
  ...
  private initializeGameMetrics(): GameMetrics {
    return {
      sessionDuration: 0,
      levelsPlayed: 0,
      enemiesDefeated: 0,
